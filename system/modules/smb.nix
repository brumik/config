...
let
  options = ["x-systemd.automount,noauto,x-systemd.idle-timeout=60,x-systemd.device-timeout=5s,x-systemd.mount-timeout=5s,credentials=${config.sops.secrets."brum/smb-credentials".path},gid=${toString config.users.groups.smbusers.name},file_mode=0664,dir_mode=0775"];
