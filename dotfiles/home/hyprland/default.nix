{ pkgs, ... }:
{
  ...
  home.file.".config/rofi/nord.rasi".source = ./rofi/nord.rasi;
...
monitor =  DP-1,5120x1440@239.9,auto,auto
exec-once = hyprpaper
...
# Fo all categories, see https://wiki.hyprland.org/Configuring/Variables/
input {
    kb_layout = us
    kb_variant =
    kb_model =
